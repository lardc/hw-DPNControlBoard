...
#define REG_PRESSURE_CHECK_DELAY		6	// Время задержки повторного измерения давления, мс
#define REG_CONTACTOR_DELAY				7	// Время ожидания переключения контактора, мс
#define REG_CHARGE_TIMEOUT				8	// Таймаут заряда конденсаторов, мс
#define REG_DISCHARGE_TIMEOUT			9	// Таймаут разряда конденсаторов, мс
//
